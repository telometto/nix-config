...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.tmpfiles.rules = lib.optionals (cfg.fluxGitAuthSecretFile != null) [
      # k3s auto-applies any YAML in this directory; placing the SSH secret here
      # means flux-instance can pull from the Git remote without a manual step.
