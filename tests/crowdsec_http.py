    ...
    try:
        ...
        dynamic = {
            "http": {
                "routers": {
                    "fixture": {
                        "entryPoints": list(settings["entryPoints"]),
        ...
        settings["global"] = {"checkNewVersion": False, "sendAnonymousUsage": False}
        ...
        with (
            ...
            process = subprocess.Popen(
                [traefik, f"--configFile={config_file}"], stdout=stdout, stderr=stderr
            )
