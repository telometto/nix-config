...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| R-01 | Complete and keep auditable the host-owned MicroVM network-policy rollout | Security / MicroVMs | Now | Shaping | — | Reconcile current main, live deployment evidence, the ADR, and dated audit records; retain only verified rollout gates and follow-ups | [microvm-base.nix](../modules/virtualisation/microvm-base.nix), [vm-registry.nix](../vms/vm-registry.nix), [Blizzard MicroVMs](../hosts/blizzard/virtualisation/microvms.nix) | [Security sequence](security-roadmap-implementation-order.md), [network-policy ADR](adr/0002-enforce-host-owned-microvm-network-policy.md), [Blizzard audit](2026-08-13-blizzard-intrusion-audit.md) |
| R-02 | Restore forensic HTTP detection and client attribution, with durable security-log retention | Observability / Security | Now | Shaping | — | Validate CrowdSec message-only acquisition, the trusted-proxy client-IP contract, persistent retention, and alerts through the approved workflow | [crowdsec.nix](../hosts/blizzard/security/crowdsec.nix), [traefik.nix](../hosts/blizzard/security/traefik.nix), [blackbox.nix](../hosts/blizzard/monitoring/blackbox.nix) | [Blizzard audit](2026-08-13-blizzard-intrusion-audit.md) |
...
| R-07 | Scope host service exposure to intended interfaces and sources, with IPv4/IPv6 parity | Networking / Security | Next | Candidate | — | Inventory all-interface listeners, define source intent, and test both allowed and denied paths | [Blizzard host configuration](../hosts/blizzard/), [networking.nix](../hosts/blizzard/networking.nix), [storage services](../hosts/blizzard/storage/) | [Blizzard audit](2026-08-13-blizzard-intrusion-audit.md) |
...
| R-09 | Make container and deployment provenance reviewable | Supply chain / Operations | Later | Candidate | — | Pin mutable image tags and record configuration revision and lock provenance in deployment records | [containers](../containers/), [service modules](../modules/services/), [CI workflows](../.github/workflows/) | [Blizzard audit](2026-08-13-blizzard-intrusion-audit.md) |
...
No initiatives have been archived yet. When an item is completed or dropped,
move it here with its final status, date, reason, and relevant links.
